                    ...
                    <Col xs="6" md="6" lg="3" >
                        <ul className="footer__social">
                            <li className="facebook">
                                <a href="#" rel="noopener  noreferrer" target="_blank" aria-label="facebook icon">
                                    <i className="icon ion-social-facebook"></i>
                                </a>
                            </li>
                            <li className="instagram">
                                <a href="https://twitter.com/_wilsonkinyua" rel="noopener noreferrer" target="_blank" aria-label="instagram icom">
